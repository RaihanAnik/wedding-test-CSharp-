...
namespace wedding_test_2
{
    public partial class Addfoodcs : Form
    {
        ...
        private void Addfoodcs_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into FoodTable values (@name,@price,@pic)";
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "delete from Foodtable where name=@name";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@name", textBox2.Text);
