...
{
    public partial class Addphotographer : Form
    {
        ...
        private void Addphotographer_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into PhotographyTable values (@name,@price,@pic)";
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "select * from PhotographyTable ";
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "delete from PhotographyTable where name=@name";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@name", textBox2.Text);
